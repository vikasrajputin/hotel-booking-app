package com.hotel.service.jwthelper;
...
public class JwtService {
    ...
    private static final long ACCESS_TOKEN_EXPIRATION_TIME = 1000 * 60 * 5; // 5 minutes in milliseconds
    private static final long REFRESH_TOKEN_EXPIRATION_TIME = 1000 * 60 * 10; // 10 minutes in milliseconds
...
//        return (username.equals(userDetails.getUsername()) && !isTokenExpired(token));
    ...
    private String createToken(Map<String, Object> claims, String userName, long expirationTimeMillis) {
        return Jwts
                .builder()
                .setClaims(claims)
                .setSubject(userName)
